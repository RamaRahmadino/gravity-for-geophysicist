...
# from SpactrumAnalysis_GITHUB import SpectrumAnalysis1D
"Spectrum analysis 1D" \
"Input Parameters: " \
"1. coordinat X,Y (1D)" \
"2. Potential Fields" \
"3. loc or intersection point (depending on grid width)" \
"4. slicing paramters: 1 (N-S) dan 2 (E-W)" \
"5. space"

# Regional, residual= SpectrumAnalysis1D(x, y, zi, 88, 1, space)

from Derivaitve import HorizontalGradeintMagnitude, SecondVerticalDerivative
"Derivative analysis for potential fields" \
"Calculation using finite difference technique with 3 points" \
"Input Parameters: "\
"1. coordinat X,Y (1D)"\
"2. Potential Fields in 2D (CBA, Reisudal, Regional etc)"

x_HGM, y_HGM, g_HGM = HorizontalGradeintMagnitude(x, y, zi)
x_SVD, y_SVD, g_SVD = SecondVerticalDerivative(x, y, zi)
